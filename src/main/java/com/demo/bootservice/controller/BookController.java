package com.demo.bootservice.controller;
...
import com.demo.bootservice.service.BookServiceImpl;
...
//	Update Book
	...
	public ResponseEntity<Book> updateBookId(@PathVariable("id") int id, @RequestBody Book book) {
...
//	Delete Book
	...
	public ResponseEntity<?> deleteBookByID(@RequestParam("id") int id) {
		...
		return new ResponseEntity<String>("Book Deleted with given Id", HttpStatus.OK);
	}
}
